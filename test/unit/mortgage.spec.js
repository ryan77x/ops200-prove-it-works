...
describe('Mortgage Calculator', () => {
    ...
    it('should return correct monthly morgage payment when principal=10000, interest=2%, term=0.1yrs and period=12', () => {
        mortgage = new Mortgage(10000, 2, 0.1, 12);
        expect(mortgage.monthlyPayment()).to.equal(8348.61);
    });

    it('should return correct monthly morgage payment when principal=10000, interest=0.001%, term=10yrs and period=12', () => {
        mortgage = new Mortgage(10000, 0.001, 10, 12);
        expect(mortgage.monthlyPayment()).to.equal(83.34);
    });

    it('should return correct monthly morgage payment when principal=0, interest=5.5%, term=10yrs and period=12', () => {
        mortgage = new Mortgage(0, 5.5, 10, 12);
        expect(mortgage.monthlyPayment()).to.equal(0);
    });

    it('should return correct monthly morgage payment when principal=1, interest=5.5%, term=10yrs and period=12', () => {
        mortgage = new Mortgage(1, 5.5, 10, 12);
        expect(mortgage.monthlyPayment()).to.equal(0.01);
    });
